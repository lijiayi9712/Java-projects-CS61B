...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            Node current = new Node(Double.parseDouble(attributes.getValue("lat")),
...
//            System.out.println("Node lat: " + attributes.getValue("lat"));
            ...
            activeState = "way";
            way = new Way(Long.parseLong(attributes.getValue("id")));
            nodesonway = new LinkedList<>();
            //System.out.println("Beginning a way...");
        } else if (activeState.equals("way") && qName.equals("nd")) {
            /* While looking at a way, we found a <nd...> tag. */
            //System.out.println("Id of a node in this way: " + attributes.getValue("ref"));
            String test = attributes.getValue("ref");
            Node curr = g.vertexes.get(Long.parseLong(attributes.getValue("ref")));
            nodesonway.add(curr);
            lastNode = curr;
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            if (flag) {
                Iterator iter = nodesonway.iterator();
