...
public class Parser {
    ...
    public static String helper_eval(String query) {
        eval(query);
        return query;
    }
    ...
    private static void printTable(String name) {  //Changes
        for (int i = 0; i < DB.tables.size(); i += 1) {
    ...
    private static void select(String exprs, String tables, String conds) {
        ...
        String[] tablenames = tables.split("\\s*(\\s|,)\\s*");
